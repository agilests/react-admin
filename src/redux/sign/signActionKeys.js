export default {
    fetchSigns: 'FETCH_SIGNS',
    fetchSignsSuccess: 'fetchSignsSuccess',
    fetchSignsFailed: 'fetchSignsFailed',
    fetchSignTemplates: 'FETCH_SIGN_TEMPLATES',
    fetchSignTemplatesSuccess: 'FETCH_SIGN_TEMPLATES_SUCCESS',
